...
return false}
var abc2svg={}
function dom_loaded(){var errtxt='',new_page='',playing,abcplay,page,a_src=[],a_pe=[],glop,old_gm,jsdir=(function(){var scrs=document.getElementsByTagName('script')
for(var i=0;i<scrs.length;i++){var a=scrs[i].src.match(/(.*?\/)abcemb-.\.js/)
if(a)
return a[1]}})(),user={errmsg:function(msg,l,c){errtxt+=clean_txt(msg)+'\n'},img_out:function(str){new_page+=str},page_format:true};playconf={onend:function(){playing=false}}
